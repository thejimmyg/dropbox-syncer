...
console.log(`Setting up Dropbox URLs and file serving from ${DROPBOX_LOCAL_FOLDER_PATH}/public ...`)
ds.setupApp(app)
app.use(express.static(path.join(DROPBOX_LOCAL_FOLDER_PATH, 'public')))
console.log('done.')
